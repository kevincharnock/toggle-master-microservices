...
def update_rule(flag_name):
    ...
    query = f"UPDATE targeting_rules SET {', '.join(fields)} WHERE flag_name = %s RETURNING *"  # nosec B608 -- campos vem de lista fixa no codigo, nao de input do usuario
...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0', port=port, debug=False)  # nosec B104 - bind necessario dentro do container  # nosec B104 - bind necessario dentro do container
